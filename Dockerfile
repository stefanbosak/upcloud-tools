...
# container as builder for preparing UpCloud cloud tools
FROM upcloud-tools-builder AS upcloud-tools-kpt-builder

LABEL stage="upcloud-tools-kpt-builder" \
      description="Debian-based container builder for preparing UpCloud cloud tool kpt CLI" \
      org.opencontainers.image.description="Debian-based container builder for preparing UpCloud cloud tool kpt CLI" \
      org.opencontainers.image.url=https://github.com/stefanbosak/upcloud-tools \
      org.opencontainers.image.source=https://github.com/stefanbosak/upcloud-tools
...
# container as builder for preparing UpCloud cloud tools
FROM upcloud-tools-builder AS upcloud-tools-tofu-builder

LABEL stage="upcloud-tools-tofu-builder" \
      description="Debian-based container builder for preparing UpCloud cloud tool OpenTofu" \
      org.opencontainers.image.description="Debian-based container builder for preparing UpCloud cloud tool OpenTofu" \
      org.opencontainers.image.url=https://github.com/stefanbosak/upcloud-tools \
      org.opencontainers.image.source=https://github.com/stefanbosak/upcloud-tools
...
# download OpenTofu archive file
...
COPY --from=upcloud-tools-ansible-cli-builder "/usr/local/share/uv/tools" "/usr/local/share/uv/tools"
...
COPY --from=upcloud-tools-kpt-builder "/usr/local/bin/" "/usr/local/bin/"
...
COPY --from=upcloud-tools-tofu-builder "/usr/local/bin/" "/usr/local/bin/"
